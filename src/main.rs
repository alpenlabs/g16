...
use garbled_snark_verifier::{
    FrWire, G1Wire, G2Wire, Gate, WireId,
    ark::{self, AffineRepr, CircuitSpecificSetupSNARK, SNARK, UniformRand},
    circuit::{CircuitInput, CircuitMode, EncodeInput, WiresObject, modes::ExecuteMode},
    groth16_verify,
    storage::Credits,
};
...
use crate::{credits::CreditCollectionMode, translator::TranslationMode};
...
fn run(k: usize) {
    ...
    use garbled_snark_verifier::circuit::{StreamingMode, component_meta::ComponentMetaBuilder};
