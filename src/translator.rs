...
use ckt::{
    GateType,
    v4::{self, a::writer::CircuitWriter},
};
...
pub struct TranslationMode {
    ...
    writer: Option<CircuitWriter<BufWriter<File>>>,
    pb: ProgressBar,
}
...
impl TranslationMode {
    pub fn new(
        ...
        let writer = CircuitWriter::new(BufWriter::new(file), primary_inputs, outputs).unwrap();
    ...
    pub fn finish(&mut self) {
        self.writer.take().unwrap().finish().unwrap();
        self.pb.finish();
    }
