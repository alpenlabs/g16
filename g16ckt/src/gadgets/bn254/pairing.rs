...
pub(crate) fn double_in_place(r: &mut ark_bn254::G2Projective) -> ark_bn254::Fq6 {
...
fn add_in_place(r: &mut ark_bn254::G2Projective, q: &ark_bn254::G2Affine) -> ark_bn254::Fq6 {
...
fn g2_affine_neg_evaluate<C: CircuitContext>(circuit: &mut C, q: &G2Projective) -> G2Projective {
...
pub(crate) fn ell_by_constant_montgomery<C: CircuitContext>(
    circuit: &mut C,
    f: &Fq12,
...
mod tests {
    ...
    use crate::{
        ...
        gadgets::{
            ...
            bn254::{
                final_exponentiation::final_exponentiation_montgomery, fp254impl::Fp254Impl,
                g2::G2Projective as G2Wires,
            },
        },
    };
